...
class ExternalOnScreenKeyboardView(
    ...
    /** Gives a newly opened lower display a deterministic D-pad entry point. */
    fun requestControllerFocus() {
        keyButtons.firstOrNull()?.button?.requestFocus()
    }
    ...
    private fun createKeyBackground(
        ...
        return StateListDrawable().apply {
            ...
            addState(intArrayOf(android.R.attr.state_focused), shape(keyHighlightColor))
