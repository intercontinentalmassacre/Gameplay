...
object PrefManager {
    ...
    private val SYSTEM_AUDIO_ENABLED = booleanPreferencesKey("system_audio_enabled")
    /** Global system audio toggle surfaced in the system menu. Placeholder until a real mixer exists. */
    var systemAudioEnabled: Boolean
        get() = getPref(SYSTEM_AUDIO_ENABLED, true)
        set(value) = setPref(SYSTEM_AUDIO_ENABLED, value)
    ...
    private val DS_HOME_NAV_MODE = intPreferencesKey("ds_home_nav_mode")
    /** Second-display library navigation: 0 = grid, 1 = list, 2 = hero shelf, 3 = cover wall. */
    var dsHomeNavMode: Int
        get() = getPref(DS_HOME_NAV_MODE, 0).coerceIn(0, 3)
        set(value) = setPref(DS_HOME_NAV_MODE, value.coerceIn(0, 3))
