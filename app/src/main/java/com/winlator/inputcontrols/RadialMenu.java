...
public class RadialMenu {
    ...
    public static RadialMenu createDefault() {
        ...
        menu.addSlot(new Slot("", Binding.KEY_I));
        menu.addSlot(new Slot("", Binding.KEY_M));
        menu.addSlot(new Slot("", Binding.KEY_J));
        menu.addSlot(new Slot("", Binding.KEY_F5));
        menu.addSlot(new Slot("", Binding.KEY_F9));
        menu.addSlot(new Slot("", Binding.KEY_ESC));
        menu.addSlot(new Slot("", Binding.KEY_TAB));
        menu.addSlot(new Slot("", Binding.SHOW_KEYBOARD));
        return menu;
    }
    ...
    public static RadialMenu fromJSONObject(JSONObject object) {
        ...
        menu.setName(object.optString("name", ""));
